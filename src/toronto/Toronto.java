 ...
 * @author Abhirham
 */
public class Toronto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jCheckBox1.setText("Software Engineering");
    ...
    private void jCheckBox2ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox2ItemStateChanged
       if(jCheckBox2.isSelected())
           ...
           count--; 
    cid[count]="200";// TODO add your handling code here:
    ...
    private void jCheckBox3ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox3ItemStateChanged
        if(jCheckBox3.isSelected())
           ...
           count--;
    cid[count]="300";// TODO add your handling code here:
    ...
    private void jCheckBox4ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox4ItemStateChanged
       if(jCheckBox4.isSelected())
           ...
           count--; 
    cid[count]="400";// TODO add your handling code here:
    ...
    private void jCheckBox5ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox5ItemStateChanged
       if(jCheckBox5.isSelected())
           ...
           count--; 
     cid[count]="500";// TODO add your handling code here:
    ...
    private void jCheckBox6ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox6ItemStateChanged
        if(jCheckBox6.isSelected())
           ...
           count--;
        cid[count]="600";// TODO add your handling code here:
       ...
       if(checksid() && count>0){
               ...
               try{
                    for(int it=1;it<=count;it++){
                        String sql = "INSERT INTO ENROLL_TORONTO (STU_ID,COURSE_ID) VALUES ("+sid1.getText()+","+cid[it]+")";
                        pst = conn.prepareStatement(sql);
                        pst.execute();
                    }
...
this.dispose();// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Toronto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public boolean checksid(){
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, ex);
             ...
             if(id<Integer.parseInt(sid1.getText()) || Integer.parseInt(sid1.getText())<100000)
                return false;
            else
                return true;
