...
public class updatestud extends javax.swing.JFrame {
        ...
        jPanel7Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(pmobile, javax.swing.GroupLayout.PREFERRED_SIZE, 131, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(96, 96, 96))
        );
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        if(checksid()){
            String sql = " select STU_MOB,STU_EMAIL,STU_PAR_MOB, STU_ADDRESS, STU_CITY, STU_PROVINCE, STU_ZIP_CODE "
                    + "from STUDENT_TORONTO where STU_ID="+sid.getText()+"";
            try {
    ...
    private void updatebtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updatebtnActionPerformed
       ...
       String sql;
       if(date==1){
           sql = " update STUDENT_TORONTO set STU_MOB="+mobile.getText()+",STU_EMAIL='"+email.getText()+"',STU_PAR_MOB="+pmobile.getText()+", STU_ADDRESS='"+aptno.getText()+"', STU_CITY='"+city.getText()+"', STU_PROVINCE='"+province.getText()+"', STU_ZIP_CODE='"+zip.getText()+"' "
